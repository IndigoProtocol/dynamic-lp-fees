...
async function main() {
    ...
    const seed = "mouse carpet zebra giant just pizza very song simple state rebel lunar above naive bundle accuse buffalo hurry mango scorpion country silly layer average"
    const walletAddr = "addr_test1qz280luwccrquk3lk4ykjjsexl840ppsy2u6vtq4wflwa2c279l7xk8kwpt4zc27c4dsngvpyuqn700m3s8e0k6fw9nsdudnqx";
    ...
    const tx = await updatePoolFeeTx(
        lucid,
        {
